...
| $\mathbf{A_r}$               | Radiation state matrix                | $\begin{bmatrix} -2.7078 & 3.1078  & -2.7078 & 2.7078 \\ -1.9403 & 1.5403 & -1.5403 & 1.5403 \\ -1.3122 & 1.3122 & -1.3122 & 5.3560 \\ 2.0435 & -2.0435 & -2.0003 & -2.0435 \end{bmatrix}$        |
| $\mathbf{B_r}$               | Radiation input matrix                | $\begin{bmatrix} 2.7078 & 1.5403 & 1.3122 & -2.0435 \end{bmatrix}^T$                                                                                                                              |
| $\mathbf{C_r}$               | Radiation output matrix               | $\begin{bmatrix} 23214.043986 & 23198.820014 & -44584.0254375 & -141900.8654375 \end{bmatrix}$                                                                                                    |
| $\rho$                       | Water density                         | 1025 kg/m³                                                                                                                                                                                        |
| $A_{sail}$                   | Effective sail area                   | 32.0 m²                                                                                                                                                                                           |
...
**Note:**
Linear wave theory is used for modeling the wave surface elevation, using the following associated parameters:
